...
"""
MetaTools – PubChem search + ultimate RDKit-based SMILES harmonization & classification
November 20, 2025 – now uses Corinna's gold-standard RDKit pipeline (no CIR, no network)
"""
